...
/**
 * Servlet implementation class deletetoping
 */
@WebServlet("/deletetoping")
public class deletetoping extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pdb.execupdateordelete(queryb.setprefix("tp").addupdatequerystart("pizzatopping").addbooleanequlksto("active", false).addwhere().addnumequlksto("pizzatoppingid", parser.getInt("id")).buildquery());
