...
public class deletedrink extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pdb.execupdateordelete(queryb.setprefix("dr").addupdatequerystart("drink").addbooleanequlksto("active", false).addwhere().addnumequlksto("drinkid", parser.getInt("id")).buildquery());
